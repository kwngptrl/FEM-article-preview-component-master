 ...
 */ 
    ...
    btn.addEventListener("click", (e) => {
      ...
      /* If the viewport is less than 768px then unhide/hide tooltip AND hide user photo, name, date, and change to dark background, invert icon color */  
        toggleAll();
    ...
    document.addEventListener("click", (e) => {
      let elem = e.target;
      /* The '!elem.closest(".icon-share") is used here as it doesn't work properly in desktop mode without it  */
